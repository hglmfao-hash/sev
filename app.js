...
window.toggleLang = function() {
  lang = lang === 'en' ? 'kr' : 'en';
  document.title = lang === 'kr' ? '현우' : 'rykei';
  initApp();
};
...
function initApp() {
        ...
        <div class="sidebar-wrap" id="sidebarWrap">
          ...
          <aside class="sidebar">
            <div class="sidebar-profile">
              ...
              <div class="sidebar-handle">@ak1haru</div>
            </div>
            <div class="sidebar-socials">
              ...
              <a href="https://discord.com/users/1511625910170943579" class="discord-btn" target="_blank" rel="noopener noreferrer" title="Discord">${icons.discord}<span class="discord-hover">@ak1haru</span></a>
            </div>
  ...
  window.setPage = function(page) {
    ...
    content.innerHTML = ROUTES[page]() + '<div class="main-footer">© rykei</div>';
...
function initSettings() {
  ...
  content.addEventListener('click', e => {
    ...
    if (btn && btn.dataset.config !== undefined) {
      content.className = 'main-content'; 
      void content.offsetWidth;
      content.innerHTML = renderConfigDetail(btn.dataset.config) + '<div class="main-footer">© rykei</div>';
    ...
    if (e.target.closest('#configBack')) {
      content.className = 'main-content'; 
      void content.offsetWidth;
      content.innerHTML = renderSettings() + '<div class="main-footer">© rykei</div>';
...
function initProjects() {
  ...
  content.addEventListener('click', e => {
    ...
    if (btn && btn.dataset.proj) {
      content.className = 'main-content'; 
      void content.offsetWidth;
      if (btn.dataset.proj === 'portfolio') content.innerHTML = renderPortfolio() + '<div class="main-footer">© rykei</div>';
      if (btn.dataset.proj === 'achievements') content.innerHTML = renderAchievements() + '<div class="main-footer">© rykei</div>';
      content.classList.add('slide-in-right');
      content.scrollTo({ top: 0, behavior: 'smooth' });
      return;
    }
    ...
    if (e.target.closest('#projBack')) {
      content.className = 'main-content'; 
      void content.offsetWidth;
      content.innerHTML = renderProjectsRoot() + '<div class="main-footer">© rykei</div>';
      content.classList.add('slide-in-left');
      content.scrollTo({ top: 0, behavior: 'smooth' });
    }
  });
